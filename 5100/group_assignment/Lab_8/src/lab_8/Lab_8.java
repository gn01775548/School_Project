...
//        helper.getFiveMostLikedComment();
        helper.averageLikesPerComment(); // solution to question1
        helper.postwithMostLikedComments();// solution to question2
        helper.postWithMostComments(); // solution to qeustion3
        helper.top5InactiveUsersBasedPosts();// solution to question4
        helper.top5InactiveUsersBasedComments(); // solution to qeustion5
        helper.top5InactiveUsers();// solution to question6
        helper.top5ProactiveUsers();// solution to question7
