...
public class ManageProdPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDirectory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prod Name ", "Availablity", "Price", "Descrption"
            }
        ) {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if(selectedRow<0){
            ...
            Product prod = (Product)tblDirectory.getValueAt(selectedRow, 0);
            ViewPanel vvpanel = new ViewPanel(rightPanel, prod);
            rightPanel.add("ViewPanel",vvpanel);
            CardLayout layout = (CardLayout)rightPanel.getLayout();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(result == null){
            ...
            ViewPanel vpanel = new ViewPanel(rightPanel, result);
